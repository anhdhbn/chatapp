...
public class User {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        ObjectOutputStream outputStream1 = new ObjectOutputStream(user1.getSocket().getOutputStream());
        ...
        ObjectOutputStream outputStream2 = new ObjectOutputStream(user2.getSocket().getOutputStream());
